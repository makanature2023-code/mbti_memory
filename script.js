document.addEventListener('DOMContentLoaded', () => {
    ...
    const scents = {
        '백화산': {
            desc: {
                INTJ: '계획적이고 전략적인 당신에게,숲의 고요함은 머릿속의 복잡함을 맑게 정리해 줍니다. 레몬유칼립투스의 깔끔한 향이 깊은 사과와 집중을 도와주는 숲속 명상 같은 시간.',
                ESFP: '감각적이고 활동적인 당신에게 상쾌한 숲 향은 일상의\n에너지를 충전해주는 자연의 숨결.핀란드의 아침을\n떠올리게 하는 레몬,편백,사이프러스의 조화'
            }
        },
        '안흥진성': {
            desc: {
                ESTJ: '분명하고 책임감 있는 당신에게, 바다의 기운이 새로운\n결단의 힘이 되어줍니다. 페퍼민트와 유칼립투스가\n머릿속을 정리하고 나아갈 방향을 선명하게 밝혀줍니다',
                INFP: '꿈과 가치를 향해 나아가는 당신에게, 바람을 타고\n전해지는 향은 응원처럼 다가옵니다. 프랑킨센스와\n베르가못의 조화가 응축된 내면의 에너지를 깨웁니다'
            }
        },
        '안면송림': {
            desc: {
                ISFJ: '배려 깊고 따뜻한 당신에게, 파인니들과 사이프러스의\n조화로운 소나무숲의 향은 마음에 잔잔한 안식을 선물합니다.\n피톤치드의 부드러운 울림이 온기를 품은 안정감을\n만들어줍니다',
                ENTP: '창의적이고 도전적인 당신에게, 솔바람 향은 흩어진 아이디어를\n모아주는 리듬이 됩니다. 베티버와 샌달우드의 에너지가\n창의력에 균형감을 더해줍니다.'
            }
        },
        '만리포': {
            desc: {
                ENFJ: '사람을 이끄는 따뜻한 리더십을 가진 당신에게, 노을빛 향기는\n정서적 공감을 넓히는 다리입니다. 유자와 자몽의 부드러운\n감귤향은 마음을 열고 포용하게 합니다.',
                ISTP: '논리적이면서도 감각적인 당신에게 저녁 바람처럼 다가오는\n향이 감정의 스위치를 켜줍니다. 만다린과 유자의 산뜻함이\n일상 속 짧은 쉼표가 됩니다.'
            }
        },
        '신두사구': {
            desc: {
                ISFP: '감성이 풍부한 당신에게, 따사로운 모래의 향기는 예술적인\n상상을 자극합니다. 프랑킨센스와 샌달우드의 조화는 내면의 \n감성을 부드럽게 꺼내줍니다',
                ENTJ: '결단력 있는 당신에게, 고요한 사구의 힘은 에너지를\n정돈하고 비전을 확장시키는 기반이 됩니다.\n샌달우드의 무게감과 로즈마리의 감성이 균형을 잡아줍니다.'
            }
        },
        '가의도': {
            desc: {
                ENFP: '아이디어가 넘치는 당신에게, 햇살 속 꽃내음은 영감을\n가득 품은 아침 같은 향.\n시트러스와 꽃향이 긍정 에너지를 더해줍니다',
                ISTJ: '바닐라와 자스민의 정돈된 고급스러움은 체계적이고 신중한\n당신에게 안정감을 전합니다. 스윗오렌지는 약간의 기분전환과\n생기를 더해 너무 딱딱해지지 않도록 부드러운 균형을\n잡아주는 향'
            }
        },
        '몽산해변': {
            desc: {
                INFJ: '깊이 있는 통찰과 감성을 가진 당신에게, 파도에 잠긴 향기는\n내면의 평화를 회복시켜 줍니다. 네를리와 라벤더가 조용한\n밤의 안식처가 되어줍니다',
                ESTP: '라벤더와 네롤리의 순한 플로럴은 활동적이고 즉흥적인 당신의\n속도를 잠시 멈추게 하며 아미리스의 잔잔한 우디함은 \n혼란스러운 감정에 차분한 균형을 가져다 줍니다'
            }
        },
        '할미·할아비바위': {
            desc: {
                INTP: '끝임없이 생각하고, 논리로 세계를 해석하는 당신에게 로즈와\n일랑일랑의 향은 오래된 사람의 기억처럼 따뜻하게 스며듭니다.\n감정이 흐르고 머물 수 있는 공간 같은 향기.',
                ESFJ: '시더우드와 제라늄의 밸런스는 사람을 살피고, 따뜻하게\n연결하는 당신의 기질을 차분하게 정돈합니다. 로즈와 \n오스만투스의 고급스러운 플로럴 터치는 당신 안의 부드러움을\n자연스럽게 드러나게 하는 향.'
            }
        }
    };
